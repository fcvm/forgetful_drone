...
%###################### Topic B             ########################################
%###################################################################################
\section{Direct Policy Imitation Learning}
...
%@misc{Cunha13,
%  author        = {},
%  title         = {Lecture in Principles of Robot Autonomy II},
%  year          = {2022},
%  publisher={Autonomous Systems Lab of Stanford University}
%}
or "alternative"
%https://drive.google.com/file/d/12QdNmMll-bGlSWnm8pmD_TawuRN7xagX/view
to RL (reinforcement learning),
or the "fusion" 
%https://www.cl.uni-heidelberg.de/courses/ws18/iml/L1.pdf
...
The imitation loss function quantifies 
